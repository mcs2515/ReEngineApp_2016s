...
#pragma region YOUR CODE GOES HERE
	...
	float degrees = MapValue(fTimer, 0.0f, 2.5f, 0.0f, 360.0f); //in 2.5sec go in a full circle
	...
	modelMatrix *= glm::translate(vector3(0.0f, 3.0f, 0.0f)); //always stay 3 units away
	//add the reverse rotation to cancel out
	modelMatrix *= glm::transpose(glm::toMat4(rotate));
